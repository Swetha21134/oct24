...
public class TC_lab6TestNG {
    ...
    public Object[][] dp() {
        return new Object[][] {
            {"yanalaswetha17@gmail.com", "Swetha@123"},  // Correct credentials
            {"swetha2025r@example.com", "incorrectPassword"}  // Incorrect credentials for negative testing
        };
    }
